...
// Always include email in the insert since it's required by the database
        ...
        if ($stmt->execute()) {
            $message = '<div class="alert alert-success">
                ...
                <div class="alert alert-info">
                    ...
                    if ($email) {
                        $message .= '<p class="mb-0"><strong>Email:</strong> ' . htmlspecialchars($email) . '</p>';
                    }
                    $message .= '</div>
                </div>
            ...
            $message = '<div class="alert alert-danger">Error creating account: ' . $con->error . '</div>';
        }
    }
}
