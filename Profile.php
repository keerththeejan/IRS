            ...
            <div class="tab-pane" id="permissions">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Manage what you can do on the platform.</p>
                                ...
                                <form id="permissionsForm">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch mb-3">
                                            <input type="checkbox" class="custom-control-input" id="viewProfile" checked disabled>
                                            <label class="custom-control-label" for="viewProfile">View Profile</label>
                                            <small class="form-text text-muted">Allows you to view your profile information</small>
                                        </div>
                                        
                                        <div class="custom-control custom-switch mb-3">
                                            <input type="checkbox" class="custom-control-input" id="editProfile">
                                            <label class="custom-control-label" for="editProfile">Edit Profile</label>
                                            <small class="form-text text-muted">Allows you to update your profile information</small>
                                        </div>
                                        ...
                                        <div class="custom-control custom-switch mb-3">
                                            ...
                                            <small class="form-text text-muted">Receive email notifications about important updates</small>
                                        </div>
                                        
                                        <div class="custom-control custom-switch mb-3">
                                            <input type="checkbox" class="custom-control-input" id="enrollModules">
                                            <label class="custom-control-label" for="enrollModules">Enroll in Modules</label>
                                            <small class="form-text text-muted">Allows you to enroll in available modules</small>
                                        </div>
                                        
                                        <div class="custom-control custom-switch mb-3">
                                            <input type="checkbox" class="custom-control-input" id="viewGrades">
                                            <label class="custom-control-label" for="viewGrades">View Grades</label>
                                            <small class="form-text text-muted">View your grades and academic progress</small>
                                        </div>
                                    </div>
                        ...
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-info-circle"></i> Some permissions may be required by the system and cannot be changed.
                        </div>
                    </div>
                </div>
            </div>
